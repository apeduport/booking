...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.StudentInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).student.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.StudentInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).student.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.StudentInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).student.findFirst(input as any))),

        findMany: procedure.input($Schema.StudentInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).student.findMany(input as any))),
        ...
        count: procedure.input($Schema.StudentInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).student.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.StudentCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.StudentCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.StudentCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.StudentCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.StudentCountArgs>, 'cursor'>,
